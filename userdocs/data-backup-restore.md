...
Use the standalone `System > Setup > Backup / Restore` action to move Octessera user
...
1. On a Pi board, choose `System > Setup > Backup / Restore`.
...
4. On the fresh board, choose `System > Setup > Backup / Restore` again. Use the new
