...
|---:|---|---|---|
| 1 | Enclosure top | Board-specific artifact from `../../release-artifacts/enclosure/stl/` | The generated tops are named for Raspberry Pi Zero 2 W and Orange Pi Zero 2W. Fit the exact board before ordering a final print. |
...
| 4 | MX keycaps | Print `../../release-artifacts/enclosure/stl/mx_keycap_*.stl`, use matching `../../release-artifacts/enclosure/3mf-multicolor/mx_keycap_*_multicolor_flush.3mf`, or use any MX-stem keycap | Four NeoKey caps: back, play, shift, and function/layer. Transparent filament for the cap body lets the color LEDs shine through. |
