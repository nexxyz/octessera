...
| USB audio or MIDI is missing | Check the documented data port, cable direction, and enclosure power input. | [USB roles](hardware/usb-roles.md), [safety and power](hardware/safety-and-power.md#usb-data) |
