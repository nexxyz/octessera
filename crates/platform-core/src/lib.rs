...
pub use platform_capabilities::{
    ...
    AUX_ENCODER_COUNT, BUS_COUNT, BUS_FX_WARNING_SLOT_COUNT, GLOBAL_FX_SLOT_COUNT,
    INSTRUMENT_COUNT, LAYER_COUNT, OLED_HEIGHT, OLED_WIDTH, PAN_POSITION_COUNT,
    PLATFORM_CAPABILITIES, PLAY_FX_MAX_CONCURRENT, SAMPLE_SLOT_COUNT, SAMPLE_VOICE_LANE_CAPACITY,
    SCAN_SECTION_COUNTS, SYNTH_VOICE_LANE_CAPACITY,
};
pub use transforms::{
