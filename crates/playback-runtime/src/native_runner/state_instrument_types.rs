...
pub(super) struct NativeInstrumentSlot {
    ...
    pub(super) fm_config: Value,
    pub(super) pluck_config: Value,
    pub(super) drum_config: Value,
...
impl NativeInstrumentSlot {
    pub(super) fn new(index: usize) -> Self {
        ...
        Self {
            ...
            synth_config,
            fm_config: super::synth_config::fm_default_config(),
            pluck_config: super::synth_config::pluck_default_config(),
            drum_config: super::drum_config::drum_default_config(),
            synth_gain_pct: 80,
            sample_tune_semis: 0,
            sample_gain_pct: 100,
            sample_amp_env,
