use super::binding_link_axis::{link_axis_binding_group, link_axis_lane_binding_group};
use super::binding_tree::binding_action;
use super::{group, NativeMenuConfig, NativeMenuItem};

pub(super) fn link_binding_group(
    index: usize,
    label: &str,
    config: &NativeMenuConfig,
    target: &str,
) -> Option<NativeMenuItem> {
    let sense = config.link_layers.get(index)?;
    ...
    Some(group(
        ...
        vec![
            ...
            link_axis_binding_group(&format!("{prefix}.x"), "X Axis", target),
            link_axis_lane_binding_group(
            ...
            link_axis_binding_group(&format!("{prefix}.y"), "Y Axis", target),
            link_axis_lane_binding_group(
