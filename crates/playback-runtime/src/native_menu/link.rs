use super::link_axis::{axis_group, AxisMenuConfig};
use super::link_sections::{
...
use super::{
    ...
    NativeLinkLayerConfig, NativeMenuConfig, NativeMenuItem, NativeValueLaneConfig,
};
pub(super) fn default_link_layer_config() -> NativeLinkLayerConfig {
    NativeLinkLayerConfig {
        scan_mode: "none".into(),
        scan_axis: "rows".into(),
        scan_unit: "1/8".into(),
...
pub(super) fn link_layer_group(
    index: usize,
    label: String,
    instrument_options: &[String],
    sense: Option<&NativeLinkLayerConfig>,
    ...
    let default_sense = default_link_layer_config();
...
pub(super) fn link_root_items(config: &NativeMenuConfig) -> Vec<NativeMenuItem> {
    vec![
