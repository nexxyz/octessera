...
pub(crate) fn config() -> NativeMenuConfig {
    NativeMenuConfig {
        ...
        instrument_fm_configs: vec![serde_json::json!({})],
        instrument_pluck_configs: vec![serde_json::json!({})],
        instrument_drum_configs: vec![serde_json::json!({})],
        instrument_drum_selected_voices: vec![0],
