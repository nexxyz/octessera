...
pub(crate) fn affected_behavior_help_targets_keep_one_accurate_row() {
    let cases: &[(&str, &str, &str, &str, &[&str])] = &[
        (
            ...
            "*",
            "key:layers.*.build.behaviorConfig.cellLife",
            "number",
            &["crystal growth", "dla"],
        ),
        (
        ...
        (
            ...
            "*",
            "key:layers.*.build.behaviorConfig.erosionPct",
            "number",
            &["sand ripples", "rivers"],
        ),
        (
            ...
            "*",
            "key:layers.*.build.behaviorConfig.diffusionPct",
            "number",
        ...
        (
            "Menu > Build > L*: * > Growth",
            "*",
            "key:layers.*.build.behaviorConfig.growthPct",
            "number",
            &["coral", "vines"],
        ),
        (
            "Menu > Build > L*: * > Branch",
            "*",
            "key:layers.*.build.behaviorConfig.branchPct",
            "number",
            &["cracks", "vines"],
        ),
        (
            ...
            "*",
            "key:layers.*.build.behaviorConfig.evaporationPct",
            "number",
            &["physarum", "rivers"],
        ),
        (
    ...
    let fallback = NativeMenuHelpTarget {
        ...
        key: "key:layers.*.build.behaviorConfig.rangeMin".into(),
        kind: "number".into(),
