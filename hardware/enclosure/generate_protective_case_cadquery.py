...
def export_all(params: dict) -> None:
    ...
    write_parts_3mf(paths[2], [("transport_case_deep_tub_debossed_logo", orient_for_print(debossed_deep_tub, "negative_z"), 1)])
    ...
    write_parts_3mf(
        paths[3],
        [("transport_case_deep_tub_body", apply_print_transform(multicolor_deep_tub, deep_transform), 1)]
    ...
    write_parts_3mf(paths[6], [("transport_case_shallow_lid_debossed_branding", orient_for_print(debossed_shallow_lid, "positive_z"), 1)])
    ...
    write_parts_3mf(
        paths[7],
        [("transport_case_shallow_lid_body", apply_print_transform(multicolor_shallow_lid, shallow_transform), 1)]
