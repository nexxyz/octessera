...
write_config "$MIDI_CONFIG" '{"runtimeConfig":{"audioOutputs":{"dac":true,"usb":false,"hdmi":true},"usb":{"midiOutEnabled":true,"dataRole":"gadget"}}}'
write_config "$COMBINED_CONFIG" '{"runtimeConfig":{"audioOutputs":{"dac":true,"usb":true,"hdmi":false},"usb":{"midiOutEnabled":true,"dataRole":"gadget"}}}'
write_config "$AUDIO_CONFIG" '{"runtimeConfig":{"audioOutputs":{"dac":true,"usb":true,"hdmi":false},"usb":{"midiOutEnabled":false,"dataRole":"gadget"}}}'

write_config "$TEST_ROOT/audio-100.json" '{"runtimeConfig":{"audioOutputs":{"dac":true,"usb":false,"hdmi":false},"usb":{"midiOutEnabled":false,"dataRole":"gadget"}}}'
write_config "$TEST_ROOT/audio-010.json" '{"runtimeConfig":{"audioOutputs":{"dac":false,"usb":true,"hdmi":false},"usb":{"midiOutEnabled":false,"dataRole":"gadget"}}}'
write_config "$TEST_ROOT/audio-001.json" '{"runtimeConfig":{"audioOutputs":{"dac":false,"usb":false,"hdmi":true},"usb":{"midiOutEnabled":false,"dataRole":"gadget"}}}'
write_config "$TEST_ROOT/audio-110.json" '{"runtimeConfig":{"audioOutputs":{"dac":true,"usb":true,"hdmi":false},"usb":{"midiOutEnabled":false,"dataRole":"gadget"}}}'
write_config "$TEST_ROOT/audio-101.json" '{"runtimeConfig":{"audioOutputs":{"dac":true,"usb":false,"hdmi":true},"usb":{"midiOutEnabled":false,"dataRole":"gadget"}}}'
write_config "$TEST_ROOT/audio-011.json" '{"runtimeConfig":{"audioOutputs":{"dac":false,"usb":true,"hdmi":true},"usb":{"midiOutEnabled":false,"dataRole":"gadget"}}}'
write_config "$TEST_ROOT/audio-111.json" '{"runtimeConfig":{"audioOutputs":{"dac":true,"usb":true,"hdmi":true},"usb":{"midiOutEnabled":false,"dataRole":"gadget"}}}'
write_config "$TEST_ROOT/audio-zero.json" '{"runtimeConfig":{"audioOutputs":{"dac":false,"usb":false,"hdmi":false},"usb":{"midiOutEnabled":false,"dataRole":"gadget"}}}'
write_config "$TEST_ROOT/audio-extra.json" '{"runtimeConfig":{"audioOutputs":{"dac":true,"usb":false,"hdmi":false,"extra":false},"usb":{"midiOutEnabled":false,"dataRole":"gadget"}}}'
write_config "$TEST_ROOT/usb-extra.json" '{"runtimeConfig":{"audioOutputs":{"dac":true,"usb":true,"hdmi":false},"usb":{"midiOutEnabled":false,"dataRole":"gadget","unexpected":true}}}'
