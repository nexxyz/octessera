...
rm -f "$ROOTFS_DIR/run/octessera/setup-portal.request" "$ROOTFS_DIR/run/octessera-setup-control/status.json"
rm -rf "$ROOTFS_DIR/run/octessera-setup" "$ROOTFS_DIR/run/octessera-setup-control" "$ROOTFS_DIR/run/octessera-setup-status"
