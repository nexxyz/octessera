...
grep -qF 'select_snapshot_render' "$root/apps/pi-zero/src/render_loop_worker.rs"
grep -qF 'retry_oled_decision' "$root/apps/pi-zero/src/render_loop_worker.rs"
grep -qF 'retry_oled_if_due' "$root/apps/pi-zero/src/render_loop_worker.rs"
