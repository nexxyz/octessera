...
required_files=(
  ...
  "$root/tools/armbian-image/verification-profile.sh"
  ...
  "$root/tools/armbian-image/fixtures/h618-orange-ahub-base.dts"
  "$root/tools/armbian-image/fixtures/h618-stock-i2c1-pi.dts"
  ...
  "$root/tools/pi-image/test-usb-role.sh"
  ...
  "$root/tools/pi-image/test-rpi-sudoers-construction.sh"
  ...
  "$root/tools/pi-image/validate-rpi-parent-sudoers.sh"
