...
INPUTS = [
    ...
    Path("crates/platform-capabilities-build/Cargo.toml"),
    Path("crates/platform-core/Cargo.toml"),
    Path("crates/playback-runtime/Cargo.toml"),
    Path("crates/realtime-engine/Cargo.toml"),
    Path("crates/rodio-engine-source/Cargo.toml"),
    Path("crates/hal/Cargo.toml"),
    ...
    Path("tools/release/check_version_consistency.py"),
