...
RPI_TOOLS = ("tools/pi-image/verify-sanitized-image.sh", "tools/pi-image/verify-managed-runtime.sh", "tools/pi-image/verify-boot-layout.sh", "tools/pi-image/verify-trusted-parent-v0.7.5.sh", "tools/pi-image/verify-rpi-kernel-image.sh", "tools/pi-image/verify-rpi-kernel-image.py", "tools/pi-image/rpi_initramfs_proof.py", "tools/pi-image/install-rpi-kernel.py", "tools/pi-kernel/rpi_kernel_contract.py", "tools/pi-kernel/rpi_kernel_image.py", "tools/pi-kernel/validate-rpi-kernel-package.py", "tools/pi-image/stage3-octessera-kernel/files/root/usr/local/lib/octessera/install-rpi-kernel.py", "tools/pi-image/stage3-octessera-kernel/files/root/usr/local/lib/octessera/rpi_kernel_contract.py", "tools/pi-image/stage3-octessera-kernel/files/root/usr/local/lib/octessera/rpi_kernel_image.py", "tools/pi-image/stage3-octessera-kernel/files/root/usr/local/lib/octessera/raspi_firmware_hook_mask.py", "tools/pi-image/stage4-octessera/files/root/usr/local/lib/octessera/rpi_uart_release.py", "tools/legal/stage_notices.py", "resources/legal/notice-bundle.json", "tools/image-respin/notice_mutation.py", "tools/kernel-patches/orange-midi-interface-manifest.json", "resources/image-construction/boot-layers/raspberry-pi-zero-2w.json")
