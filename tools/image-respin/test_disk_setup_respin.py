...
class DiskSetupRespinTests(unittest.TestCase):
    def test_ext4_and_vfat_setup_respin_uses_the_separate_layer_and_preserves_source(self) -> None:
        ...
        with tempfile.TemporaryDirectory() as temporary:
            ...
            self.assertEqual(set(setup_provenance["changed_paths"]), {"usr/local/lib/octessera/setup_config.py", "usr/local/sbin/octessera-setup", "usr/local/share/octessera-setup-ui/README.md", "usr/local/share/octessera-setup-ui/index.html", "usr/local/share/octessera-setup-ui/js/app.js", "var/lib/octessera/recordings", "var/lib/octessera/screen-recordings"})
