...
try {
  ...
  $result.schema_version = 9; $result | Add-Member -NotePropertyName worker_timing_mode -NotePropertyValue "enabled"
  ...
  $invalidSchedulingCpu = ConvertFrom-Json -InputObject ($result | ConvertTo-Json -Depth 8); $invalidSchedulingCpu.callback_scheduling_cpu = 2
  Assert-Throws { Assert-OrangeLiveResult -Result $invalidSchedulingCpu -Selection $selection }
  $invalidSchedulingPriority = ConvertFrom-Json -InputObject ($result | ConvertTo-Json -Depth 8); $invalidSchedulingPriority.callback_scheduling_priority = 69
  Assert-Throws { Assert-OrangeLiveResult -Result $invalidSchedulingPriority -Selection $selection }
  $inlineFailure = ConvertFrom-Json -InputObject ($result | ConvertTo-Json -Depth 8); $inlineFailure.status = "fail"; $inlineFailure.executor_mode = "inline"; $inlineFailure.worker_health = "disabled"; $inlineFailure.worker_thread_name_0 = ""; $inlineFailure.worker_thread_name_1 = ""; $inlineFailure.joined_workers = 0; $inlineFailure.worker_timing_mode = "disabled"; $inlineFailure.worker_timing = $null; $inlineFailure.callback_scheduling_priority = 70; $inlineFailure.callback_scheduling_cpu = $null
