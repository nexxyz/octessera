...
try {
  ...
  $invalidPersistentMonotonic = ConvertFrom-Json -InputObject ($result | ConvertTo-Json -Depth 8); $invalidPersistentMonotonic.persistent_output_counters.start.rendered_quantums = 2; Assert-Throws { Assert-OrangeLiveResult -Result $invalidPersistentMonotonic -Selection $selection }
