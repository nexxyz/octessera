...
- Pause: `⏸`
- Stop: `■`
- Stop, accepted MIDI Start, and resync reset the transport origin, scan, autonomous Build cadence, Pattern phase, and Looper playback position while preserving evolved worlds, configuration, and recorded loop. Pause/Continue resumes the exact phase.
